...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('subtotal',10,2); // Replace with the appropriate precision and scale
            $table->decimal('commission_owed',10,2)->default(0.00); // Replace with the appropriate precision and scale
